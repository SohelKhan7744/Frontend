...
function Students() {
 ...
 <div className="w-full">
  ...
  {/* Card Wrapper */}
  <div className="bg-[#222d32] border border-[#1e293b] rounded-lg shadow-md overflow-hidden">
    ...
    {/* Pagination */}
    <div className="flex justify-end items-center gap-3 px-6 py-4 border-t border-[#1e293b] bg-[#25343F]">
      <button
        disabled={page === 1}
