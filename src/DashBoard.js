    ...
    useEffect(()=>{
       ...
       if(revenueCtx){
        ...
        revenueChart = new Chart(revenueCtx,{
           type : "line", data : {
            labels : ["Students","Teachers","Courses","Enrollment"],
            datasets :[{
                label : "Overview",
                data : [
                  stats.students,
                ...
                borderColor : "#17a2b8",
                backgroundColor : "rgba(23,162,182,0.2)",
                fill : true,
                tension : 0.4
            }]
           },
      ...
      <div className="container-fluid">
        ...
        <div className="row">
          <div className="col-lg-3 col-6">
            ...
            <div className="small-box bg-info">
              ...
              <div className="icon">
               ...
               More info <i className="fas fa-arrow-circle-right" /></Link>
            </div>
          </div>
          {/* ./col */}
          <div className="col-lg-3 col-6">
            ...
            <div className="small-box bg-success">
              <div className="inner">
                <h3>{stats.courses}<sup style={{fontSize: 20}}></sup></h3>
                <p>Courses</p>
              </div>
              <div className="icon">
          ...
          <div className="col-lg-3 col-6">
           ...
           <Link to="/admin/teacher" className="small-box-footer">
               More info <i className="fas fa-arrow-circle-right" /></Link>
            </div>
          </div>
          {/* ./col */}
          <div className="col-lg-3 col-6">
            ...
            <div className="small-box bg-danger">
              <div className="inner">
                <h3>{stats.enrollment}</h3>
                <p>Enrollment</p>
              </div>
              <div className="icon">
                <i className="ion ion-pie-graph" />
              </div>
              <Link to="/admin/enrollments" className="small-box-footer">
               More info <i className="fas fa-arrow-circle-right" /></Link>
            </div>
          </div>
          {/* ./col */}
              ...
              <div className="card-footer bg-transparent">
                <div className="row">
                  <div className="col-4 text-center">
                   <div className='text-white h4'>{stats.visitors}</div>
                    <div className="text-white">Visitors</div>
                  </div>
                  {/* ./col */}
                  <div className="col-4 text-center">
                    <div className='text-white h4'>{stats.onlineNow}</div>
                    <div className="text-white">Online</div>
                  </div>
                  {/* ./col */}
                  <div className="col-4 text-center">
                 <div className='text-white h4'>-</div>
